...
public class ApiClient implements Constants{
    ...
    public static Retrofit getClient(String headers, String URL) {
        OkHttpClient okHttpClient;
        switch (headers){
            case OAUTH:
                okHttpClient = okhttpOAuth();
                break;
            case VENDING:
                okHttpClient = okhttpVending();
                break;
            default:
                okHttpClient = okhttpOAuth();
        }
    ...
    private static OkHttpClient okhttpOAuth() {
    ...
    private static OkHttpClient okhttpVending() {
        return new OkHttpClient.Builder()
                .addInterceptor(new Interceptor() {
                    @Override
